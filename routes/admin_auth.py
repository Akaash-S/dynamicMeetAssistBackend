...
def admin_login():
    ...
    try:
        ...
        if AuthConfig.is_default_admin(email, password):
            ...
            users = get_db().execute_query(user_query, (email,))
            ...
            if not users:
                ...
                """
                get_db().execute_query(create_user_query, (
        ...
        get_db().execute_query(update_login_query, (datetime.utcnow(), user['id']))
...
def log_admin_action(admin_email: str, action: str, resource_type: str = None, 
    ...
    try:
        ...
        get_db().execute_query(log_query, (
