...
def get_notifications():
    ...
    GET /api/admin/notifications?page=1&per_page=20&type=&priority=&is_read=
    """
    try:
        ...
        # Execute query
        notifications = get_db().execute_query(base_query, params)
...
def get_notification_stats():
    ...
    try:
        ...
        type_result = get_db().execute_query(type_query)
        type_breakdown = [
            {
                'type': row['type'],
                'count': row['count']
...
def update_notification(notification_id):
    ...
    try:
        ...
        notifications = get_db().execute_query(notification_query, (notification_id,))
...
def delete_notification(notification_id):
    ...
    try:
        ...
        get_db().execute_query(delete_query, (notification_id,))
