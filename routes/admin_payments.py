...
def get_payments():
    ...
    GET /api/admin/payments?page=1&per_page=20&status=&method=&search=
    """
    try:
        ...
        # Execute query
        payments = get_db().execute_query(base_query, params)
...
def get_payment_stats():
    ...
    try:
        ...
        overview_result = get_db().execute_query(overview_query, (month_start,))
        ...
        method_result = get_db().execute_query(method_query)
        method_breakdown = [
            {
...
def get_revenue_chart():
    ...
    GET /api/admin/payments/revenue-chart?period=7d
    """
    try:
        ...
        chart_result = get_db().execute_query(chart_query, (start_date,))
...
def update_payment(payment_id):
    ...
    try:
        ...
        payments = get_db().execute_query(payment_query, (payment_id,))
...
def process_refund(payment_id):
    ...
    try:
        ...
        get_db().execute_query(update_query, (datetime.utcnow(), payment_id))
