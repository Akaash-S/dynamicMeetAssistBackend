...
def get_users():
    ...
    try:
        ...
        # Execute query
        users = get_db().execute_query(base_query, params)
...
def get_user_details(user_id):
    ...
    try:
        ...
        users = get_db().execute_query(user_query, (user_id,))
        ...
        for stat_name, query in stats_queries.items():
            result = get_db().execute_query(query, (user_id,))
...
def update_user(user_id):
    ...
    try:
        ...
        # Get updated user
        updated_users = get_db().execute_query(user_query, (user_id,))
...
def delete_user(user_id):
    ...
    try:
        ...
        get_db().execute_query(deactivate_query, (datetime.utcnow(), user_id))
...
def get_user_stats():
    ...
    try:
        ...
        overview_result = get_db().execute_query(overview_query)
        ...
        auth_provider_result = get_db().execute_query(auth_provider_query)
        ...
        trends_result = get_db().execute_query(trends_query)
        registration_trends = [
            {
