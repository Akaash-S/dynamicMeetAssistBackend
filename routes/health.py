...
def check_database_health():
    ...
    try:
        ...
        result = rds_db.execute_query(test_query)
        
        # Get pool status
        pool_status = rds_db.get_pool_status()
        ...
        return {
            ...
            'connection_pool': rds_db.get_pool_status()
        }
    except Exception as e:
        return {
            'service': 'database',
...
def get_database_metrics():
    ...
    try:
        ...
        processing_result = rds_db.execute_query(processing_query)
        ...
        completed_result = rds_db.execute_query(completed_query)
        ...
        failed_result = rds_db.execute_query(failed_query)
        ...
        """
        recent_result = rds_db.execute_query(recent_query)
...
def get_storage_metrics():
    ...
    try:
        ...
        size_result = rds_db.execute_query(size_query)
        ...
        files_result = rds_db.execute_query(files_query)
